package org.metrichosu.mcollect.parser.external.seoulTemperature
...
class SeoulTemperature : ExternalSourceParser {
	...
	override fun parseDataFromSource(mid: String): MetricValue {
		...
		return MetricValue(
				...
				requestResult.currentWeatherInfo.temperature
		)
	}
}