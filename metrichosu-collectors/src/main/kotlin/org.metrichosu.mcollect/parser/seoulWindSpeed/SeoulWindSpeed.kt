package org.metrichosu.mcollect.parser.seoulWindSpeed
...
class SeoulWindSpeed: ExternalSourceParser {
    ...
    override fun parseDataFromSource(mid: String): MetricValue {
        ...
        val requestResult = this.httpClient.send(getRequest, HttpResponse.BodyHandlers.ofString())
            .let {
                ObjectMapper().readValue(it.body(), SeoulWindSpeedDto::class.java)
            }
