...
public class AlarmMessageConverter {
    ...
    public void handle(SNSEvent snsEvent) {
        List<DeliveryMessage> deliveries =  snsEvent.getRecords().stream()
                .map(this::extractAlarmMessage)
    ...
    private CloudWatchAlarmMessage extractAlarmMessage(SNSEvent.SNSRecord snsRecord) {
